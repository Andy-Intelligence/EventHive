...
const eventSchema = new Schema(
  {
    ...
    eventLatitude: { type: Number }, // Assuming it's a location description or coordinates
    eventLongitude: { type: Number }, // Assuming it's a location description or coordinates
