    ...
    <div className="flex items-center p-2 gap-2 h-[4.5rem]">
      ...
      >
        ...
        <input
          ...
          required
          className=" digitalID-input peer block w-full rounded-lg border border-gray-200 bg-white py-2.5 pr-24 text-lg shadow-lg font-sans font-medium focus:border-black focus:outline-none focus:ring-0  pl-5 h-full  "
        />

        <button
          type="submit"
          // onClick={}
          className="submit-btn hover:border-gray-700 hover:text-gray-700 absolute inset-y-0 right-0 my-1.5 mr-1.5 flex w-10 items-center justify-center font-sans text-sm font-medium text-gray-400 peer-focus:border-gray-700 peer-focus:text-gray-700"
        >
